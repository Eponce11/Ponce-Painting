...
export const text =
  "These are our featured services, designed to provide reliable solutions that meet the needs of every client.";
export const btn = {
  text: "View More",
  link: "/about-us",
};
...
export const services = [
  {
    ...
    description:
      "We manage projects from start to finish, ensuring everything is handled seamlessly",
    link: {
      text: "Learn More",
      link: "/about-us",
    },
  },
  {
    ...
    description:
      "We install and remove furniture for hotels and other commercial buildings.",
    link: {
      text: "Learn More",
      link: "/about-us",
    },
  },
  {
    ...
    title: "Renovation",
    description:
      "We specialize in the renovation of spaces, creating refreshed and updated environments tailored to your needs.",
    link: {
      text: "Learn More",
      link: "/about-us",
    },
  },
  {
    ...
    description:
      "We provide expert wallpaper removal and installation, along with professional painting services, to transform any space.",
    link: {
      text: "Learn More",
      link: "/about-us",
    },
